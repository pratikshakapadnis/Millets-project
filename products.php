...
<div class="container" style="margin-top:65px">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Millets Types</li>
            </ol>
        </nav>
        <!--breadcrumb end-->
    <hr/>
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="Images/jowar-millet.png" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Hulled - jowar</h6>
                    <h6>Price :Rs 30/Kg</h6>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="Images/Rajmudi_rice.png" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Rajmudi-rice</h6>
                    <h6>Price :Rs 30/Kg</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="Images/ragi.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Ragi </h6>
                    <h6>Price :Rs 50/Kg</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="Images/Pearl millet.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Pearl millet</h6>
                    <h6>Price :Rs 35/kg</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="Images/wheat.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Wheat</h6>
                    <h6>Price :Rs 40/Kg</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
