...
<head>
  ...
  <title>  About INDIA'S MILLETS</title>
      ...
      <div class="row justify-content-around">
        ...
        <div class="col-md-5 mt-3">
          <span class="text-warning pt-3">
            <h1 class="title">Health is Wealth</h1>
            
          </span>
          <hr>
          <p>Millet is an ancient grain that people have enjoyed for thousands of years. Millet is also food for livestock and birds. It is becoming increasingly popular as it is fast-growing, drought-resistant, and requires low input.
