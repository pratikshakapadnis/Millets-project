    ...
    <div class="container-fluid mt-5 pt-5" id="content" style="margin-bottom:200px">
            <div class="col-md-8 mx-auto">
                <div class="jumbotron text-center">
                      <h3>Your order is confirmed. Thank you for buying grains with us.</h3><hr>
                    <p>Click <a href="products.php">here</a> to purchase any other grains.</p>
                </div>
            </div>
        </div>
         <!-- footer-->
